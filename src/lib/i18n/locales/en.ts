...
const sponsorsSection = {
  ...
  backerDialog: {
    ...
    optionPayPalDescription: "Due to limited integration options with PayPal, please get the confirmation e-mail and a screenshot after donating, then open a support ticket on our Discord server to receive your perks. We are looking into improving this process in future updates.",
    optionOpenCollectiveText: "Contribute via",
    optionOpenCollectiveDescription: "After donating, please get the confirmation e-mail and a screenshot, then open a support ticket on our Discord server to receive your perks. We plan to integrate with OpenCollective's API soon to automate perk delivery.",
