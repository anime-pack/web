...
const heroSection: Translations['heroSection'] = {
  ...
  supportUs: "Apoie-nos",
  becomeContributor: "Seja um Contribuidor",
};
...
const sponsorsSection: Translations['sponsorsSection'] = {
  ...
  backerDialog: {
    ...
    optionOpenCollectiveDescription: "Após doar, por favor, obtenha o e-mail de confirmação e uma captura de tela, em seguida, abra um ticket de suporte em nosso servidor do Discord para receber suas vantagens. Planejamos integrar com a API do OpenCollective em breve para automatizar a entrega das vantagens.",
