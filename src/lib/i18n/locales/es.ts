...
const footer: Translations['footer'] = {
  ...
  communityLove: "Con ❤️ para la comunidad",
...
const sponsorsSection: Translations['sponsorsSection'] = {
  ...
  backerDialog: {
    ...
    optionPayPalDescription: "Debido a las opciones limitadas de integración con PayPal, por favor obtén el correo electrónico de confirmación y una captura de pantalla después de donar, luego abre un ticket de soporte en nuestro servidor de Discord para recibir tus ventajas. Estamos buscando mejorar este proceso en futuras actualizaciones.",
    optionOpenCollectiveText: "Contribuye vía",
    optionOpenCollectiveDescription: "Después de donar, por favor obtén el correo electrónico de confirmación y una captura de pantalla, luego abre un ticket de soporte en nuestro servidor de Discord para recibir tus ventajas. Planeamos integrarnos con la API de OpenCollective pronto para automatizar la entrega de ventajas.",
